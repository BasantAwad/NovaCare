...
/// After animation: loads persisted auth state and routes accordingly:
///   • Not logged in  → LoginScreen
///   • Patient        → MainNavigation
///   • Caregiver      → CaregiverNavigation
...
class _SplashScreenState extends State<SplashScreen>
  ...
  void _navigate() {
    ...
    if (!auth.isLoggedIn) {
      ...
      destination = const CaregiverNavigation();
    } else {
  ...
  Widget build(BuildContext context) {
    // Also react to AuthProvider changes so if auth resolves before the
    // 2.5 s delay, the navigation happens automatically.
                        ...
                        child: Transform.scale(
                          ...
                          child: Container(
                            ...
                            decoration: BoxDecoration(
                              ...
                              boxShadow: [
                                BoxShadow(
                                  color: AppColors.accent.withOpacity(0.18 + 0.12 * breatheT),
                    ...
                    Opacity(
                      ...
                      child: Column(
                        children: [
                          ...
                          Text('ASSISTIVE ROBOTICS', style: AppText.eyebrow().copyWith(fontSize: 11)),
                        ],
                      ),
                    ),
                    const Spacer(flex: 4),
                    Opacity(opacity: introT, child: const _LoadingDots()),
          ...
          children: List.generate(3, (i) {
            ...
            return Padding(
              ...
              child: Opacity(
                ...
                child: Container(
                  width: 8, height: 8,
                  decoration: const BoxDecoration(color: AppColors.inkTeal, shape: BoxShape.circle),
                ),
              ),
            );
          }),
