...
/// Triggers a tone on the robot speaker via WebSocket.
...
class _PlaySoundButtonState extends State<PlaySoundButton> {
  ...
  Future<void> _onPressed() async {
    ...
    final ok = await SummonService().sendPlaySound(frequency: widget.frequency, duration: widget.duration);
    setState(() { _loading = false; _status = ok ? 'Sent' : 'Failed'; });
